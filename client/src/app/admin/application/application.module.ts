...
const components = [ApplicationSearchPageComponent, ApplicationDetailPageComponent, ApplicationSearchModalComponent, ApplicationSectionPageComponent, ApplicationPagePageComponent];

@NgModule({
	imports: [CommonModule, SearchModule, FormsModule, ApplicationRoutingModule],
