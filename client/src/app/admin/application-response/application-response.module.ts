...
const components = [ApplicationResponseSearchPageComponent, ApplicationResponseDetailPageComponent];

@NgModule({
	imports: [CommonModule, SearchModule, FormsModule, ApplicationResponseRoutingModule],
