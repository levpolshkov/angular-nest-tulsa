...
export class SearchTableComponent {
	...
	onFilterChange(instant = false) {
		// instant: If we don't want to do a debounce
	...
	private expandProp(obj: object, prop: string): any {
		// Takes key='prop1.prop2.prop3' and returns obj[prop1][prop2][prop3]
