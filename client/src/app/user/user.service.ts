...
export class UserService {
	...
	constructor(private http:HttpService, private searchService:SearchService, private storageService:StorageService, private userChangeService:UserChangeService, private modalService:NgbModal) {
	...
	getCurrentUser():Promise<User> {
		...
		return this.http.get(`/auth/user`).then(user => {
